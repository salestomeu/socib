...
public class WeatherStationApiServiceTest {
   ...
   /* @Test
    public void whenAllProductsHaveDataSourceWithInstrument() throws InterruptedException {
        ...
        WeatherStationApiService weatherStationApiService = new WeatherStationApiService(retrofitTest, new TestSchedulerProvider());

        //when
        List<FixedStation> fixedStations = UtilTest.getValue(weatherStationApiService.getFixedStationsLiveData(StationType.WEATHERSTATION.stationType()));
