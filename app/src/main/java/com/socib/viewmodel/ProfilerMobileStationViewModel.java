...
public class ProfilerMobileStationViewModel extends AbstractFixedStationViewModel {
    public ProfilerMobileStationViewModel(FixedStationApiService fixedStationApiService, SchedulerProvider schedulerProvider) {
